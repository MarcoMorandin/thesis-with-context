...
| A05 | Cross-plant held-out — **not an ablation**: this *is* the S2 evaluation protocol (knowledge/baselines.md §4.1); kept for ID continuity | `data.split=cross_plant` |  -  | FOLDED into protocol |  -  |
