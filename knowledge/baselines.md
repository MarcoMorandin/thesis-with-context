...
| **Aurora** ([arXiv:2509.22295](https://arxiv.org/abs/2509.22295)) | ✅ TS-derived pseudo-image or real satellite frame; **no text** | Generative multimodal TSFM; validation plants select pseudo vs real vision before a frozen zero-shot test run | ✅ P2 vendored `tier5/vendor/aurora` — protocol windows, 100 samples retained, exact masks. |
