...
This project is indexed by GitNexus as **thesis-with-context** (2722 symbols, 4882 relationships, 162 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
