...
uv run python -m mmtsfm.train data.dataset_name=uk_pv data.data_dir=/leonardo_scratch/fast/IscrC_MTSFM/data
...
This project is indexed by GitNexus as **thesis-with-context** (2439 symbols, 4410 relationships, 152 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
