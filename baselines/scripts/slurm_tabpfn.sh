...
# tabpfn-common-utils ships posthog telemetry that is ON by default outside CI.
# Offline, every event retries against eu.i.posthog.com and spams stderr with
# "error uploading: ... Network is unreachable" (telemetry/core/service.py).
