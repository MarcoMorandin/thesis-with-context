...
This project is indexed by GitNexus as **thesis-with-context** (3448 symbols, 6165 relationships, 130 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
