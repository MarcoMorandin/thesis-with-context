...
This project is indexed by GitNexus as **thesis-with-context** (2321 symbols, 4096 relationships, 134 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
