...
This project is indexed by GitNexus as **thesis-with-context** (2721 symbols, 4881 relationships, 162 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
