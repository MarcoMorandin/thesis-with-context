...
try:
    ...
    pass
from .utils import interpolate_quantiles, weighted_quantile
...
class Chronos2Pipeline(BaseChronosPipeline):
    ...
    def _predict_fev_window(
        ...
        **predict_kwargs,
        ...
        from .dataset import convert_fev_window_to_list_of_dicts_input
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *args, **kwargs):
        ...
        _arch_map = {"Chronos2Model": Chronos2Model}
        class_ = _arch_map.get(architecture)
