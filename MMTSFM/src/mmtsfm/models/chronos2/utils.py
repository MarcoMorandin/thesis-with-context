...
def weighted_quantile(
    ...
    """
    # Known approximation: linear interpolation outside the quantile range. Acceptable for
    # the current quantile levels [0.1..0.9] where extrapolation is rare in practice.
